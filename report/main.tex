...
\section{Gestão de Utilizadores}
    ...
    pertencente ao \textit{facade} da aplicação - isto é, a classe \textit{ActivityPlanner}.
    ...
    Estes são modificados através dos métodos \textit{set} da classe \textit{User},
    e, logo após, o respetivo utilizador é atualizado na lista de utilizadores da aplicação,
...
\section{Gestão de Atividades}
    ...
    Antes da aplicação prosseguir com a apresentação do submenu de gestão de atividades de interesse,
    ...
    e esta é adicionada à lista de atividades de interesse do utilizador, que, posteriormente, é atualizado na lista de utilizadores da aplicação.
    ...
    Nesta opção, são apresentadas todos os nomes das atividades de interesse de um utilizador, e este tem a opção de selecionar a atividade que pretende remover. Esta é removida da lista de atividades de interesse do utilizador,
...
\section{Registo e Visualização de Atividades Completas}
    ...
    Segue-se um exemplo de como as calorias são calculadas para uma atividade de corrida no monte:

    \begin{figure}[!ht]
        \centering
        \includegraphics[width=\textwidth]{images/calories.png}
        \caption{Exemplo do Cálculo de Calorias}
        \label{fig:calories}
    \end{figure}
...
\section{Gestão de Plano de Treino}
    ...
    e estas são selecionadas, assim como a hora e o número de repetições das mesmas.
    ...
    Como de costume, o utilizador é atualizado na lista de utilizadores da aplicação.
    ...
    sendo o número máximo de atividades por semana deste tipo limitado a apenas três
    ...
    visto que as atividades deste tipo são restritas a três por semana é necessário, nestes casos, colocá-las em primeiro
    ...
    Nesta opção, é removido o plano de treino de um utilizador se tal existir, e,
    ...
    para tal, atualizámos os outros métodos de forma a garantir que não hajam
    ...
    através da iteração sobre a lista de eventos do plano de treino do mesmo,
...
\section{Simulação}
    ...
    por quem, e a atividade praticada, a que horas, bem como o respetivo consumo calórico.
...
\section{Estatísticas}
    ...
    \subsection{Utilizador que mais atividades realizou}
        ...
        No caso de esta estatística ser executada num intervalo de tempo,
        são apenas considerados os registos de atividades dentro desse intervalo.

    \subsection{Tipo de atividade mais praticada}
        Para o cálculo do tipo de atividade mais praticada, é iterado sobre todos os utilizadores da aplicação,
        e, para cada um, é iterado sobre todos os registos de atividades do utilizador.
        Seguidamente, através do uso de um dicionário, é contado o número de vezes que cada tipo de atividade é praticado,
    ...
    \subsection{Quantos kms que um utilizador percorreu}
        Para determinar quantos kilómetros um utilizador percorreu, em primeiro lugar, é selecionado o utilizador em questão,
        e, de seguida, é iterado sobre todos os registos de atividades deste utilizador. De seguida,
        através do método \textit{isDistanceBased} da classe \textit{Activity} é verificado se a atividade é baseada em distância,
    ...
    \subsection{Qual o plano de treino mais exigente em função do dispêndio de calorias proposto}
        ...
        Seguidamente, é calculado o dispêndio de calorias de cada plano de treino,
        através da iteração sobre todos os eventos de cada um,
