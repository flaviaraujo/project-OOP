...
\section{Gestão de Plano de Treino}
    ...
    \begin{itemize}
        \item \textit{Calorias mínimas} - Calorias mínimas a serem queimadas no plano de treino;
        \item \textit{Número máximo de atividades por dia} - Número máximo de atividades a serem praticadas por dia, máximo três;
        \item \textit{Número máximo de atividades distintas por dia} - Número máximo de atividades distintas a serem praticadas por dia, máximo três;
        \item \textit{Número máximo de repetições por atividade} - Número máximo de repetições a serem praticadas por atividade por semana;
        \item \textit{Ativadades de interesse} - Atividades de interesse selecionadas pelo utilizador, que podem ser praticadas no plano de treino;
    \end{itemize}
    ...
    (exemplo: domingo, terça-feira, quinta-feira).
